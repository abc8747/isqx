...
[`isq.mkdocs.extension.IsqExtension`][] is responsible for injecting
[cross-referenced details][isq.details.Details] into the docstrings of
...
[`isq.details.Detail`][] blocks and highlights them.
...
class IsqPluginConfig(Config):  # type: ignore
    definitions = Type(list, default=[])
    """Modules that contain the definitions, e.g. `isq.iso80000`, `isq.aerospace`.

    This is used to provide cross-references within the [`isq.details.Detail`][]
    blocks.
    ...
    """Paths to the details mapping, e.g. `isq.details.iso80000.TIME_AND_SPACE`."""
...
class IsqPlugin(BasePlugin[IsqPluginConfig]):  # type: ignore
