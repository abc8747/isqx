...
| :----------------------- | :--------------------------------: | :-------------------------------: | :--------------------------------: | :--------------------------------: | :--------------------------------: | :------------------------: | :-------------------------------: | :-------------------------------: | :-------------------------------: | :--------------------------------: |
| [isq.Exp][]              |                 ✅                  |                 ✅                 |                 ✅                  |                 ✅                  |                 ✅                  |             ✅              |                 ✅                 |                 ✅                 | ❌¹<br/>[isq.TerminalUnitError][]  |  ❌¹<br/>[isq.TerminalUnitError][]  |
| [isq.Mul][]              |                 ✅                  |                 ✅                 |                 ✅                  |                 ✅                  |                 ✅                  |             ✅              |                 ✅                 |                 ✅                 | ❌¹<br/>[isq.TerminalUnitError][]  |  ❌¹<br/>[isq.TerminalUnitError][]  |
| [isq.Scaled][]           |                 ✅                  |                 ✅                 |                 ✅                  |                 ✅                  |                 ✅                  |             ✅              |                 ✅                 |                 ✅                 | ❌¹<br/>[isq.TerminalUnitError][]  |  ⚠️⁵<br/>[isq.TerminalUnitError][]  |
| [isq.Prefix][]^          |     ❌²<br/>[isq.PrefixError][]     |                ✅³                 |     ❌²<br/>[isq.PrefixError][]     |     ❌⁴<br/>[isq.PrefixError][]     |     ❌⁴<br/>[isq.PrefixError][]     | ❌⁴<br/>[isq.PrefixError][] |                ✅⁶                 |    ⚠️⁷<br/>[isq.PrefixError][]     |    ❌¹<br/>[isq.PrefixError][]     |     ⚠️⁵<br/>[isq.PrefixError][]     |
| [isq.Aliased][]          | ❌⁸<br/>[isq.ReferenceTypeError][]  | ❌⁸<br/>[isq.ReferenceTypeError][] | ❌⁸<br/>[isq.ReferenceTypeError][]  |                 ✅                  |                 ✅                  |             ✅              | ❌⁹<br/>[isq.ReferenceTypeError][] |                 ✅                 | ❌¹<br/>[isq.ReferenceTypeError][] | ❌⁸<br/>[isq.ReferenceTypeError][]  |
| [isq.Tagged][]           |                 ✅                  |                 ✅                 |                 ✅                  |                 ✅                  |                 ✅                  |             ✅              |                 ✅                 |   ❌¹⁰<br/>[isq.NestingError][]    |                 ✅                 |                 ✅                  |
| [isq.Translated][]       | ❌¹¹<br/>[isq.ReferenceTypeError][] |                 ✅                 | ❌¹¹<br/>[isq.ReferenceTypeError][] | ❌¹¹<br/>[isq.ReferenceTypeError][] | ❌¹¹<br/>[isq.ReferenceTypeError][] |             ✅              |                 ✅                 | ⚠️⁷<br/>[isq.ReferenceTypeError][] |    ❌¹<br/>[isq.NestingError][]    | ❌¹<br/>[isq.ReferenceTypeError][]  |
| [isq.Logarithmic][]      | ❌¹²<br/>[isq.ReferenceTypeError][] |                 ✅                 | ❌¹²<br/>[isq.ReferenceTypeError][] |                 ✅                  |                 ✅                  |             ✅              |                 ✅                 |                 ✅                 | ❌¹<br/>[isq.ReferenceTypeError][] | ❌¹²<br/>[isq.ReferenceTypeError][] |
...
8.  an [isq.Aliased][] must wrap a structural expression (`Exp`, `Mul`, `Scaled`). it cannot wrap fundamental or terminal types.
